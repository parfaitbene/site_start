...
class Module4CrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            ChoiceField::new('position')->setChoices([
                'Page d\'accueil - Haut' => Module4::POSITION_HOME_TOP,
                'Page d\'accueil - Bas' => Module4::POSITION_HOME_BOTTOM
            ])->setRequired(true),
